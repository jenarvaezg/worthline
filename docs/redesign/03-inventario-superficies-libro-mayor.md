...
| Objetivos | `/objetivos` · [`page.tsx`](../../apps/web/app/(workspace)/objetivos/page.tsx) | FIRE sin configurar, calculado, alcanzado y Coast FIRE; proyección sin edad; metas; renta pasiva sin cobros/sin gasto/cobertura; error y éxito de formulario. | `1440×1024`; `390×844` en una columna, sin truncar los estados FIRE ni renta pasiva. |
