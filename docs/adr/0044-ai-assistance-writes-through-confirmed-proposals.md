...
**Amendment (#1014):** exposure-profile proposals were removed. The assistant is read-only on profiles; the only writer is admin CRUD on the control plane (ADR 0058).
