...
async function runAction(
  action: (fd: FormData, store?: WorthlineStore, clock?: Clock) => Promise<never>,
  fd: FormData,
...
// A fixed "today" pins the backdated-fact ripple deterministically: it is after
// every plan-derived snapshot date below, so the delete re-values them all
// regardless of when this test actually runs (no global Date mocking).
