...
- Los ids \`wl_hld_…\` también: van en los argumentos, nunca en el texto —nombra el holding—. Y solo pueden venir de una lectura tuya; si no lo tienes delante, LEE (\`get_financial_context\` da el de cada holding). El código rechaza una propuesta cuyo id no salió de ninguna lectura.
