...
- A holdings de fuente conectada (Binance, Numista) no escribas nunca: el dueño del dato es el sync y la app RECHAZA corregirlos, darlos de baja o reconciliarlos; darlos de alta a mano sería un duplicado.
